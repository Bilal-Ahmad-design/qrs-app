...
export const metadata = buildMetadata({
  title: 'Contact',
  description: 'Get in touch with QRS Quantum Risk Systems',
  path: '/contact',
});
...
export default function ContactPage() {
  return (
    <main>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-light-bg-primary to-cream-50 py-32 lg:py-40">
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-between rounded-2xl border border-teal-700/10 bg-gradient-to-br from-light-bg-primary to-white p-8 sm:p-12 shadow-sm hover:shadow-md transition-shadow">
              <div>
                ...
                <h2 className="mb-4 text-3xl font-bold text-ink-900">Direct Contact</h2>
                <p className="mb-6 text-light-text-secondary leading-relaxed">
                  For urgent technical issues or complex questions, reach out to our team directly.
                </p>
              </div>
              <div>
