...
const mockSections = {
  ...
  solutions: [
    ...
    },
    {
      ...
      published: true,
      items: [
        { icon: 'building-2', title: 'Insurance', description: 'Underwriting and portfolio management', status: 'validated' },
        { icon: 'globe', title: 'Reinsurance', description: 'Treaty evaluation and pricing', status: 'validated' },
        { icon: 'briefcase', title: 'Asset Owners', description: 'Portfolio risk assessment', status: 'validated' },
        { icon: 'target', title: 'Capital Markets', description: 'Securitization and risk transfer', status: 'validated' },
      ],
    },
  ],
  regulatory: [
  ...
  verify: [
    ...
    },
    {
      ...
      published: true,
      items: [
        { icon: 'microscope', title: 'Scientific Testing', description: 'Peer-reviewed validation', status: 'validated' },
        { icon: 'bar-chart-3', title: 'Backtesting', description: 'Historical accuracy verification', status: 'validated' },
        { icon: 'target', title: 'Industry Benchmarks', description: 'Compared against industry standards', status: 'validated' },
        { icon: 'check-circle', title: 'Continuous Improvement', description: 'Regular model updates and refinements', status: 'validated' },
      ],
    },
  ],
  about: [
    ...
    },
    {
      ...
      published: true,
      items: [
        { icon: 'rocket', title: 'Innovation', description: 'Cutting-edge risk modeling technology', status: 'validated' },
        { icon: 'users', title: 'Expertise', description: 'Team of world-class scientists', status: 'validated' },
        { icon: 'globe', title: 'Global Reach', description: 'Serving clients worldwide', status: 'validated' },
        { icon: 'lightbulb', title: 'Thought Leadership', description: 'Advancing the industry forward', status: 'validated' },
      ],
    },
  ],
}
