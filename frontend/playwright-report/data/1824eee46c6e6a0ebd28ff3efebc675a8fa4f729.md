...
- Name: phase4-simplified.spec.ts >> Phase 4.1: RBAC & Security >> RBAC: reject POST /api/users without users:create permission
- Location: e2e\phase4-simplified.spec.ts:194:3
