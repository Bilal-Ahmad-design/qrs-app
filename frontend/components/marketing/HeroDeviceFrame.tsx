...
export function HeroDeviceFrame({ imageSrc, imageAlt }: HeroDeviceFrameProps) {
  return (
    <section className="bg-gradient-to-b from-ink-800 to-ink-900 py-20 lg:py-32 px-6 relative overflow-hidden">
      ...
      <div className="max-w-screen-xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div className="text-center lg:text-left order-1 lg:order-2">
            <div className="mb-4">
              <span className="inline-block px-3 py-1 rounded-full bg-teal-500/20 border border-teal-500/40 text-teal-300 text-sm font-semibold uppercase tracking-wider">
                Enterprise Risk Analytics
              </span>
            </div>

            <h1 className="font-display text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight tracking-tight">
              Quantitative Risk Systems
            </h1>

            <p className="text-lg lg:text-xl text-cream-100 mb-10 leading-relaxed max-w-xl">
