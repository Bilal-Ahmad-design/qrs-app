...
export function Button({
  ...
  const baseClasses =
    'inline-flex items-center justify-center px-4 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 rounded-md text-sm sm:text-base md:text-lg min-h-[40px] sm:min-h-[42px] md:min-h-[44px] font-body font-medium transition-colors duration-base ease-standard focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2';
